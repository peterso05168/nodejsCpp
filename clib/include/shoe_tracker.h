...
// void playRandomGame(ShoeTracker<52> &st, std::mt19937 &generator, std::vector<int> &sch) {

//     int cp1 = removeRandomCard<52>(st.remaining, generator());
//     int cp2 = removeRandomCard<52>(st.remaining, generator());
//     int cp3 = -1;

//     int cb1 = removeRandomCard<52>(st.remaining, generator());
//     int cb2 = removeRandomCard<52>(st.remaining, generator());
//     int cb3 = -1;

//     int pt = (card2val(cp1) + card2val(cp2)) % 10;
//     int bt = (card2val(cb1) + card2val(cb2)) % 10;

//     if ((pt > 7) || (bt > 7) || ((pt > 5) && (bt > 5))) {
//         // do nothing
//     } else if (pt < 6) {
//         // player draws a third card:
//         cp3 = removeRandomCard<52>(st.remaining, generator());
//         int p3 = card2val(cp3);
...
//         if (hit) {
//             cb3 = removeRandomCard<52>(st.remaining, generator());
//         }
//     } else {
